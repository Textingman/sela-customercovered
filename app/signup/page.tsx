              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-3 border border-gray-900 rounded-lg bg-black text-white placeholder-gray-500 focus:ring-2 focus:ring-gray-700 focus:border-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="block w-full px-3 py-3 border border-gray-900 rounded-lg bg-black text-white placeholder-gray-500 focus:ring-2 focus:ring-gray-700 focus:border-transparent"
